...
def eval_search_cuhk(
    ...
    for i in range(len(query_dataset)):
        ...
        for item in protoc["Gallery"][i].squeeze():
            ...
            # print("haha")
            # print(feat_g.shape)#4,256
            # print(feat_p.shape)#256,
            # feat_g1 = feat_g[:,256:512]
            # feat_q1 = feat_q[256:512]
            # sim = 0.8*feat_g.dot(feat_q).ravel()
...
def eval_search_prw(
    ...
    write_json(ret, "vis/prwresults.json")
